 ...
 * @param {dw.system.Site} site - Global session object
 */
 ...
 */
function addProductToCart(currentBasket, productId, quantity, childProducts, options, buyingAsGift) {
    var availableToSell;
